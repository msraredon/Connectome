...
``` {r  message=F, warning=F, fig.align = "center",fig.width = 6,fig.height = 6,fig.hold='hold'}
...
``` {r  message=F, warning=F,fig.align = "center",fig.width = 20,fig.height = 20}
CircosPlot(panc8.con2,min.z=1,lab.cex = 0.2,gap.degree = 0.1)
```